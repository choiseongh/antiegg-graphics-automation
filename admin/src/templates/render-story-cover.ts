...
<style>
  ...
  .contents { position:absolute; top:937px; left:0; width:1080px; height:983px; display:flex; padding:112px 0; flex-direction:column; justify-content:center; align-items:flex-start; padding-bottom:300px; box-sizing:border-box; }
  ...
  .subtitle { align-self:stretch; color:#C2C4CC; text-align:center; font-size:40px; font-weight:300; line-height:62px; }
  .bottom-contents { position:absolute; bottom:112px; left:0; width:1080px; display:flex; flex-direction:column; align-items:center; gap:50px; }
