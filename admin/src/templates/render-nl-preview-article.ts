...
<style>
  ...
  .subtitle { color:#B0B0B0; font-size:34px; font-weight:300; line-height:170%; letter-spacing:-0.68px; overflow:hidden; text-overflow:ellipsis; display:-webkit-box; -webkit-box-orient:vertical; -webkit-line-clamp:2; }
  .hero { width:940px; height:560px; object-fit:cover; object-position:${objPos}; border-radius:20px; flex-shrink:0; margin:0 auto; background:lightgray 50%/cover no-repeat;${isGray ? " filter:grayscale(100%);" : ""} }
